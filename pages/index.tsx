  ...
  return (
    <div>
      ...
      <div >
        ...
        <div className="pl-4 pt-12 text-black text-4xl w-2/3 pb-[100vh]">
          Resto del contenido acá. Lorem ipsum dolor sit amet consectetur
          adipisicing elit. Cum fugit voluptates voluptatem sunt unde
          necessitatibus possimus minus neque et incidunt cupiditate.
        </div>
      </div>
    </div>
  );
