  ...
  return (
    <div>
      ...
      <div className="h-[135vh]">
        <div className="sticky w-full pt-3 pl-4 left-0 top-0 text-gray-200 mix-blend-plus-lighter">
          <div className="w-1/2 text-6xl font-black">Catalina Andonie</div>
          <div className="flex flex-row justify-between text-3xl pr-4 pt-8 pb-4">
